const view = {
    getHeader: getHeader = (info) => {
        ...
        <img class='planet' src='source/Page_Rsc/planet.svg' style='position: relative;width: 60%;/* height: 250px; */z-index: 1;left: 20px;bottom: -85px;opacity: 0.5;animation: floatTwo 5s ease-in-out infinite;'>
        `;
        var that = this;
