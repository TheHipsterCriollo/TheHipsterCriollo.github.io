const info = [{
        title: 'Who am I? well ...',
        info: `<div class='text' style="position: relative; top: calc((100% / 2) - 180px);"><p>I am a INTERACTIVE MEDIA DESIGN student at Icesi University. My areas of interest range from web development and
        ...
        and member of the research group 418.</p></div>`
    }, {
        title: 'Skills',
        info: `
        <div class='text'>
    ...
    {
        title: 'Contact',
        info: `<div class='text' style="text-align: left">
        <ul>
        <li><h3> Write me: Jose-dgr-13@hotmail.com</h3></li>
        <li><h3> Text me: (+57) 314 732 4954</h3></li>
        <li><h3><a href='https://www.instagram.com/thehipstercriollo'> Instagram </a></h3></li>
